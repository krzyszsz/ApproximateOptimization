...
namespace ApproximateOptimization.Tests
{
    ...
    {
        private LocalAreaBinarySearch<LocalAreaBinarySearchParams> GetSut(Func<double[], double> func)
        {
            return new LocalAreaBinarySearch<LocalAreaBinarySearchParams>(new LocalAreaBinarySearchParams
            {
                getValue = func,
                dimension = 2,
                maxIterations = 1,
